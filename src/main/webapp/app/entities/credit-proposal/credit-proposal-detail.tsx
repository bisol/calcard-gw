    ...
    return (
      <Row>
        <Col md="8">
          ...
          <Button tag={Link} to="/entity/credit-proposal" replace color="info">
          ...
          &nbsp;
          <Button tag={Link} to={`/entity/credit-proposal/${creditProposalEntity.id}/edit`} replace color="primary">
